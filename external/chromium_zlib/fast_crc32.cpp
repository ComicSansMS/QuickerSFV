...
static_assert(make_crc_table() == std::array<uint32_t, 256>{
    ...
    0x5d681b02, 0x2a6f2b94, 0xb40bbe37, 0xc30c8ea1, 0x5a05df1b, 0x2d02ef8d }, "CRC table calculation is incorrect");
...
static_assert(
    ...
    (crc32_reference_tester("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod"
...
namespace detail {
/** From crc32_simd_avx512.cpp.
 * @pre buffer length must be at least 256, and a multiple of 64.
 */
uint32_t crc32_avx512_simd_(unsigned char const* buf, size_t len, uint32_t crc);

/** From crc32_simd_sse42.
